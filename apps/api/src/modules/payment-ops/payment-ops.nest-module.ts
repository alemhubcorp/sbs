...
import { AdminPaymentOpsController, PaymentWebhookController, PlatformWebhookCompatibilityController } from './payment-ops.controller.js';
...
@Module({
  ...
  controllers: [AdminPaymentOpsController, PaymentWebhookController, PlatformWebhookCompatibilityController],
